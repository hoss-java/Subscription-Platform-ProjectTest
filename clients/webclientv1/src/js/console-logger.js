...
class ConsoleLogger {
  ...
  static getInstance() {
    if (ConsoleLogger.instance === null) {
      console.log('Creating new ConsoleLogger instance');
      ConsoleLogger.instance = new ConsoleLogger();
    } else {
      console.log('Returning existing ConsoleLogger instance');
    }
  ...
  init() {
    console.log('ConsoleLogger init called');
  }
...
if (typeof module !== 'undefined' && module.exports) {
  ...
  module.exports = FirefoxParser;
  module.exports = ChromeParser;
  module.exports = SafariParser;
  module.exports = FallbackParser;
  module.exports = StackTraceParserRegistry;
