...
## 001-0029
> **Code unit tests for JavaScript frontend** ![status](https://img.shields.io/badge/status-DONE-brightgreen)
> <details >
>     <summary>Details</summary>
> 
> # DOD (definition of done):
...
> - [x] 7. Code section tests (admin.test.js, billmanager.test.js, mysubscriptions.test.js, operator.test.js, plans.test.js, profile.test.js, settings.test.js, subscriptionsman.test.js)
...
> - [x] 13. Run all tests and verify coverage report
> 
> # Reports:
